...
public class TestUtils {
	...
	public static void yakshaAssert(String testName, Object result, File file) throws IOException {
		...
		customData = "";
		try {
			customData = readData("C:\\Users\\testu\\Desktop\\Rest Assured Sample Project 10-07-2025\\custom.ih");
		} catch (Exception e) {
		}
		...
		try {
			...
			if (!(responseCode == HttpURLConnection.HTTP_OK || responseCode == HttpURLConnection.HTTP_CREATED)) {
				System.out.println(RED_BOLD_BRIGHT + "⚠️ Unable to push test cases,please try again! [" + responseCode
						+ "|" + hostName + "|" + AttemptId + "|" + length + "]" + TEXT_RESET);
			}
